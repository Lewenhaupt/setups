...
define_conditional_modmap(lambda wm_class: wm_class.casefold() not in terminals, {
    ...
    # Custom
    # K("Shift-Super"): Key.RIGHT_ALT,
    # K("Shift-Grave"): Key.RIGHT_ALT,
    # K("LM-Shift"): Key.RIGHT_ALT,
    # K("LM-Key_8"): Key.LEFT_BRACE,
    # Key.CAPSLOCK: Key.RIGHT_ALT,       # IBM
...
define_keymap(re.compile("^jetbrains-(?!.*toolbox).*$", re.IGNORECASE), {
    ...
    # Custom
    # K("Alt-Key_8"): Key.LEFT_BRACE,
    # K("Alt-Key_9"): Key.RIGHT_BRACE,
    # Debugging
...
define_keymap(lambda wm_class: wm_class.casefold() not in remotes, {
    ...
    # K("RC-LC-f"):K("Super-Up"),                   # SL- Maximize app eo
